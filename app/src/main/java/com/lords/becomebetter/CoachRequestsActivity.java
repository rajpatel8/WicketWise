    ...
    private class RequestAdapter extends RecyclerView.Adapter<RequestAdapter.RequestViewHolder> {
        ...
        class RequestViewHolder extends RecyclerView.ViewHolder {
            ...
            public void bind(CoachRequest request) {
                ...
                if (request.isPending()) {
                    requestCard.setCardBackgroundColor(Color.parseColor("#FFF3E0"));
                } else if (request.isAccepted()) {
                    requestCard.setCardBackgroundColor(Color.parseColor("#E8F5E8"));
                } else if (request.isRejected()) {
                    requestCard.setCardBackgroundColor(Color.parseColor("#FFEBEE"));
                }
            }
        }
    }
